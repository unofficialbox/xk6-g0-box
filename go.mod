module github.com/unofficialbox/xk6-g0-box

go 1.21.2

require (
	github.com/stretchr/testify v1.8.4
	github.com/szkiba/xk6-g0 v0.1.5
...
require (
	...
	github.com/stretchr/testify/_codegen v0.0.0-20231013065317-89920137cdfa // indirect
